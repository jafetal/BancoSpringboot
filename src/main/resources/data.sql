...
INSERT INTO user (id_usuario,enabled,password,username) VALUES(6,0b1,"$2a$04$XJUMQEYpIDM8eiGHfl.DguvuyECHuXyGyZdZAVstKHtUCH4Y.YE0K","user5");
INSERT INTO user (id_usuario,enabled,password,username) VALUES(7,0b1,"$2a$04$XJUMQEYpIDM8eiGHfl.DguvuyECHuXyGyZdZAVstKHtUCH4Y.YE0K","user6");
...
INSERT INTO cliente (id,id_usuario,Nombre,Correo,Telefono,Direccion,Monto) VALUES(1,2,"Jafet Alvarado","jafet@hai.com",8181818181,"Nueva vida#999",10000);
INSERT INTO cliente (id,id_usuario,Nombre,Correo,Telefono,Direccion,Monto) VALUES(2,3,"Julión Alvarez","ohls@hai.com",9191919191,"vieja vida#988",20000);
INSERT INTO cliente (id,id_usuario,Nombre,Correo,Telefono,Direccion,Monto) VALUES(3,4,"Rana Salt","yupi@hai.com",6161616161,"Actual vida#111",50000);
INSERT INTO cliente (id,id_usuario,Nombre,Correo,Telefono,Direccion,Monto) VALUES(4,5,"berwick knblood","kyouga@hai.com",7171717171,"Iggsadril#932",5000);
INSERT INTO cliente (id,id_usuario,Nombre,Correo,Telefono,Direccion,Monto) VALUES(5,6,"Aristela M","ashitaga@hai.com",3131313131,"Kanto #333",75000);
